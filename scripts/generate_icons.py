...
def remove_adaptive_icons():
    # Capacitor creates API-26 adaptive XML files that override PNG launchers.
    # Remove them so every Android version uses the branded PNGs below.
...
print('Generated forced cat-puzzle launcher icons.')